...
- **Undo** after a clean, and an honest before/after disk gauge (moving to Trash
  doesn't free space until it's emptied — LeftSpace tells you that).
...
```sh
swift run storagecleaner scan          # scan + report, no changes
